...
window.SKProductVideo={init:function(){
  ...
  var anchor=document.querySelector('.cats')||document.querySelector('.search-bar')||document.querySelector('.hero')||document.querySelector('.container')||document.body;
